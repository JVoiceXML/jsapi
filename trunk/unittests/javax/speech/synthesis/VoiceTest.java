...
public class VoiceTest extends TestCase {
    ...
    public void testGetAge() {
        ...
        final Voice voice2 = new Voice(Locale.US, "john", Voice.GENDER_MALE,
                Voice.AGE_DONT_CARE, Voice.VARIANT_DEFAULT);
        assertEquals(Voice.AGE_DONT_CARE, voice2.getAge());

        final Voice voice3 = new Voice(Locale.US, "john", Voice.GENDER_MALE,
    ...
    public void testGetGender() {
        ...
        final Voice voice3 = new Voice(Locale.US, "mary", Voice.GENDER_FEMALE,
                41, Voice.VARIANT_DEFAULT);
        assertEquals(Voice.GENDER_FEMALE, voice3.getGender());
    }

    /**
     * Test method for {@link javax.speech.synthesis.Voice#getLocale()}.
     */
    public void testGetLocale() {
        final Voice voice1 = new Voice();
        assertNull(voice1.getLocale());

        final Voice voice2 = new Voice(Locale.US, "john", Voice.GENDER_MALE,
                Voice.AGE_DONT_CARE, Voice.VARIANT_DEFAULT);
        assertEquals(Locale.US, voice2.getLocale());

        final Voice voice3 = new Voice(null, "john", Voice.GENDER_MALE,
                Voice.AGE_DONT_CARE, Voice.VARIANT_DEFAULT);
        assertNull(voice3.getLocale());
    }
    ...
    public void testGetName() {
        ...
        final Voice voice3 = new Voice(Locale.US, "", Voice.GENDER_MALE,
                Voice.AGE_DONT_CARE, Voice.VARIANT_DEFAULT);
        assertEquals("", voice3.getName());

        final Voice voice4 = new Voice(Locale.US, null, Voice.GENDER_MALE,
                Voice.AGE_DONT_CARE, Voice.VARIANT_DEFAULT);
    ...
    public void testToString() {
        final Voice voice = new Voice(Locale.US, "john", Voice.GENDER_MALE,
                Voice.AGE_DONT_CARE, Voice.VARIANT_DEFAULT);
