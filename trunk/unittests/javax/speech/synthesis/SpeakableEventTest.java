...
public class SpeakableEventTest extends TestCase {
    ...
    /**
     * Test method for
     * {@link javax.speech.synthesis.SpeakableEvent#getDescription()}.
     */
    public void testGetDescription() {
        ...
        error = null;
        try {
            description = event4.getDescription();
        } catch (IllegalStateException e) {
            error = e;
        }
        assertNotNull(error);
        ...
        error = null;
        try {
            description = event5.getDescription();
        } catch (IllegalStateException e) {
            error = e;
        }
        assertNotNull(error);
        ...
        error = null;
        try {
            description = event6.getDescription();
        } catch (IllegalStateException e) {
            error = e;
        }
        assertNotNull(error);
    ...
    public void testToString() {
        ...
        assertTrue("id not found in toString", str7.indexOf(Integer
                .toString(SpeakableEvent.MARKUP_FAILED)) >= 0);
