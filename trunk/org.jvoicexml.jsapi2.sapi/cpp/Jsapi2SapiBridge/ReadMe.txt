========================================================================
    DYNAMIC LINK LIBRARY: Jsapi2SapiBridge-Projektübersicht
========================================================================

Diese Jsapi2SapiBridge-DLL wurde vom Anwendungs-Assistenten für Sie 
erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die Jsapi2SapiBridge-Anwendung besteht.


Jsapi2SapiBridge.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen Jsapi2SapiBridge.pch sowie eine vorkompilierte 
