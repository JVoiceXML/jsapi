...
//  ExtAudioFileDispose(af);
  ...
  stat = AudioFileGetProperty(afId, kAudioFilePropertyAudioDataByteCount, &propertySize, &numBytes);
  ...
  stat = AudioFileGetProperty(afId, kAudioFilePropertyAudioDataPacketCount, &propertySize, &numPackets);
  ...
  void* buffer = malloc(numBytes);
	...
	OSStatus result = AudioFileReadPackets(afId, false, &numBytes32, NULL, 0, &numPackets32, buffer);
	if (result) {
